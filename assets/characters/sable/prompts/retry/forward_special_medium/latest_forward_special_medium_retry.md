# Retry Prompt: sable / forward_special_medium

Regenerate `forward_special_medium` for `sable`.

The previous sheet was rejected or needs retry because:

- Technical status warn is below required pass. Visual score 76 is below required 85.
