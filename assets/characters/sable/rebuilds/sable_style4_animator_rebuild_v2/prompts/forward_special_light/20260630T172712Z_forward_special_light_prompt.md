# Sable Style 4 Animator Rebuild v2 Prompt - forward_special_light

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: forward_special_light
category: special
frameCount: 14
fps: 12
loop: false
...
Phase Lunge light: short forward phase strike with restrained streaks and fast recovery.
