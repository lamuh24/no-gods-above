# Sable Style 4 Animator Rebuild v2 Prompt - up_special_light

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: up_special_light
category: special
frameCount: 14
fps: 12
loop: false
...
Vertical Phase light: quick upward phase lift/strike, compact vertical shards.
