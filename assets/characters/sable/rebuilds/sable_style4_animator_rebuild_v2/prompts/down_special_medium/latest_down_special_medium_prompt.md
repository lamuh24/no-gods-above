# Sable Style 4 Animator Rebuild v2 Prompt - down_special_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: down_special_medium
category: special
frameCount: 16
fps: 12
loop: false
...
Ground Rift medium: wider floor fracture with clearer buildup, not oversized.
