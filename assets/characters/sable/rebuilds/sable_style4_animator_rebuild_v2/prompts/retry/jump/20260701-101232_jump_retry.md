# Retry Prompt: sable / jump

Regenerate `jump` for `sable`.

The previous sheet was rejected or needs retry because:

- Technical status warn is below required pass. Visual score 8 is below required 85. Suspicious output flagged by visual QA.
