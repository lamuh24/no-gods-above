# Retry Prompt: sable / walk_forward

Regenerate `walk_forward` for `sable`.

The previous sheet was rejected or needs retry because:

- Technical status warn is below required pass. Visual score 12 is below required 85. Suspicious output flagged by visual QA.
