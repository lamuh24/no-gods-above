# Sable Style 4 Animator Rebuild v2 Prompt - neutral_special_heavy

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: neutral_special_heavy
category: special
frameCount: 18
fps: 12
loop: false
...
Void Shard heavy: strongest shard charge and release, more commitment but still in frame.
