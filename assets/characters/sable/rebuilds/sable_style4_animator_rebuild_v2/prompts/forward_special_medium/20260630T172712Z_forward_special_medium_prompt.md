# Sable Style 4 Animator Rebuild v2 Prompt - forward_special_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: forward_special_medium
category: special
frameCount: 16
fps: 12
loop: false
...
Phase Lunge medium: longer phase lunge, more visible void trail, distinct startup.
