# Sable Style 4 Animator Rebuild v2 Prompt - down_special_heavy

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: down_special_heavy
category: special
frameCount: 18
fps: 12
loop: false
...
Ground Rift heavy: strongest floor rupture, full body still visible above the effect.
