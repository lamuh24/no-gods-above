# Sable Style 4 Animator Rebuild v2 Prompt - forward_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: forward_medium
category: normal
frameCount: 10
fps: 13
loop: false
...
Advancing medium normal with longer commitment, still a normal and not a teleport.
