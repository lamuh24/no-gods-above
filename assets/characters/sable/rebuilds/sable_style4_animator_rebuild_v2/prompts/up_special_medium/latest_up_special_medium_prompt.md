# Sable Style 4 Animator Rebuild v2 Prompt - up_special_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: up_special_medium
category: special
frameCount: 16
fps: 12
loop: false
...
Vertical Phase medium: stronger upward phase motion and more crystal trail.
