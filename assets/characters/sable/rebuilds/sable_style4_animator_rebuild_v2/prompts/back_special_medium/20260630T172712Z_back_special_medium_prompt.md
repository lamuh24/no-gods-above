# Sable Style 4 Animator Rebuild v2 Prompt - back_special_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: back_special_medium
category: special
frameCount: 16
fps: 12
loop: false
...
Void Anchor medium: larger anchor formation with longer charge and more shards.
