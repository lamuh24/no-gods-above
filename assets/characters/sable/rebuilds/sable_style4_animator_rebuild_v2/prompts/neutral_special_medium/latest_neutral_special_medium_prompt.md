# Sable Style 4 Animator Rebuild v2 Prompt - neutral_special_medium

Create one complete transparent PNG or WEBP horizontal spritesheet for Sable.

clipId: neutral_special_medium
category: special
frameCount: 16
fps: 12
loop: false
...
Void Shard medium: larger shard with longer startup and clearer charge, distinct from light.
