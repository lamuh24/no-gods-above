...
# Sprite Clip Prompt: sable / jump_heavy
...
Create exactly 12 frames for `jump_heavy`.
...
full-rebuild-v3 normal attack. Heavy aerial strike with committed silhouette and strong active pose; not Vertical Phase.
