...
Create exactly 8 frames for `back_light`.
...
full-rebuild-v3 directional normal. Defensive retreating light check, not Void Anchor; no trap object or detached anchor crystal.
