...
# Sprite Clip Prompt: sable / jump_medium
...
Create exactly 10 frames for `jump_medium`.
...
full-rebuild-v3 normal attack. Aerial medium with a clearer arc and longer reach than light, preserving stable airborne scale.
