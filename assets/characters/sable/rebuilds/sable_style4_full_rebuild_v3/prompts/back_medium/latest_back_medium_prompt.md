...
# Sprite Clip Prompt: sable / back_medium
...
Create exactly 10 frames for `back_medium`.
...
full-rebuild-v3 directional normal. Back medium counter-poke with clear guarded body turn and compact forearm accents only.
