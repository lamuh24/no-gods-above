# Retry Prompt: sable / back_special_heavy

Regenerate `back_special_heavy` for `sable`.

The previous sheet was rejected or needs retry because:

- Technical status warn is below required pass. Visual score 0 is below required 85. Suspicious output flagged by visual QA.
