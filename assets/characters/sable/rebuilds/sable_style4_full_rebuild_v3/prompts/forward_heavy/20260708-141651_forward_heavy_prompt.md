...
Create exactly 12 frames for `forward_heavy`.
...
full-rebuild-v3 directional normal. Heavy advancing body-first strike with large but readable silhouette, no Phase Lunge trail.
