(() => {
  ...
  const AUDIO_SFX_PATHS = {
    hit_light: "assets/audio/sfx/hit_light.ogg",
    hit_medium: "assets/audio/sfx/hit_medium.ogg",
    hit_heavy: "assets/audio/sfx/hit_heavy.ogg",
    hit_super: "assets/audio/sfx/hit_super.ogg",
    block: "assets/audio/sfx/block.ogg",
    whoosh: "assets/audio/sfx/whoosh.ogg",
    jump: "assets/audio/sfx/jump.ogg",
    double_jump: "assets/audio/sfx/double_jump.ogg",
    dash: "assets/audio/sfx/dash.ogg",
    super_dash: "assets/audio/sfx/super_dash.ogg",
    grab_catch: "assets/audio/sfx/grab_catch.ogg",
    grab_toss: "assets/audio/sfx/grab_toss.ogg",
    super_flash: "assets/audio/sfx/super_flash.ogg",
    ko: "assets/audio/sfx/ko.ogg",
    ...
    ui_move: "assets/audio/sfx/ui_move.ogg",
  ...
  const characterProfiles = {
    ...
    sable: {
      ...
      buildPlayerAnimations: buildSablePlaceholderPlayerAnimations,
      buildEnemyAnimations: buildSablePlaceholderEnemyAnimations
    },
    seris: {
      id: "seris",
      name: "SERIS",
  ...
  const selectableCharacterIds = ["kairo", "vanta", "nyx", "sol", "seris", "sable", "lamuh", "lamuh_legacy", "celeste"];
