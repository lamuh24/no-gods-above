#!/usr/bin/env python3
"""Validate a clean Seris Sheet 7 revamp atlas before runtime wiring."""
...
def validate(input_path: Path, out_dir: Path, root: Path) -> int:
    ...
    report = {
        ...
        "contract": {
            "sheet": "Seris Sheet 7 - Knockdown / Recovery / Flavor",
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate Seris Sheet 7 revamp atlas.")
